...
image2 = image2.resize((1275, 788), Image.ANTIALIAS)
...
lbl = tk.Label(root, text="ULCER Detection System", font=('times', 30,' bold '), width=65,height=2,bg="black",fg="white")
lbl.place(x=0, y=0)
...
frame_alpr = tk.LabelFrame(root, text=" --Process-- ",fg="white", width=260, height=740, bd=5, font=('times', 14, ' bold '),bg="black")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=0, y=83)
